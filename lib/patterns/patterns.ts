...
export function detectHammer(c: OHLCCandle, prev: OHLCCandle[]): PatternResult | null {
  const downtrend = prev.length >= 3 && prev.slice(-3).every((_p, i, a) => i === 0 || a[i].close < a[i-1].close)
...
export function detectHangingMan(c: OHLCCandle, prev: OHLCCandle[]): PatternResult | null {
  const uptrend = prev.length >= 3 && prev.slice(-3).every((_p, i, a) => i === 0 || a[i].close > a[i-1].close)
...
export function detectMorningStar(c: OHLCCandle, mid: OHLCCandle, prev: OHLCCandle): PatternResult | null {
...
export function detectEveningStar(c: OHLCCandle, mid: OHLCCandle, prev: OHLCCandle): PatternResult | null {
...
export function detectThreeWhiteSoldiers(c: OHLCCandle, mid: OHLCCandle, prev: OHLCCandle): PatternResult | null {
...
export function detectThreeBlackCrows(c: OHLCCandle, mid: OHLCCandle, prev: OHLCCandle): PatternResult | null {
